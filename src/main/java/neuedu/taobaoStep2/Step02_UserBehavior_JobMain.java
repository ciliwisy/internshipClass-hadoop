package neuedu.taobaoStep2;

import neuedu.taobaoStep1.Step01_JobMain;
import neuedu.taobaoStep2.mapper.UserBehaviorMapper;
import neuedu.taobaoStep2.reducer.UserBehaviorReducer;
...
public class Step02_UserBehavior_JobMain extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int run = ToolRunner.run(conf, new Step02_UserBehavior_JobMain(), args);
        // 进程退出
        System.exit(run);
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setJarByClass(Step02_UserBehavior_JobMain.class);
        // 配置Job任务对象（8个步骤）
        ...
        Path savePath = new Path("/taobao_data_output/Step02/UserBehavior");
        ...
        if (flag){
            System.out.println("Step02_UserBehavior任务执行成功");
            return 0;
        }
        else {
            System.out.println("Step02_UserBehavior任务执行失败");
            return 1;
        }
    }
}